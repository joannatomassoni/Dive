            ...
            <View style={styles.title}>
              ...
              <View style={styles.linkRow}>
                ...
                <Ionicons
                  ...
                  size={37}
                  onPress={() => {
                    axios.patch(`https://dive-ios.appspot.com/users/${userInfo.id}/bio`, {
                      bio: newBio,
                    })
              ...
              <View style={styles.linkRow}>
                ...
                <Ionicons
                  ...
                  size={37}
                  onPress={() => {
                    axios.patch(`https://dive-ios.appspot.com/bands/${userInfo.id}/spotify`, {
              ...
              <View style={styles.linkRow}>
                ...
                <Ionicons
                  ...
                  size={37}
                  onPress={() => {
                    axios.patch(`https://dive-ios.appspot.com/bands/${userInfo.id}/fb`, {
              ...
              <View style={styles.linkRow}>
                ...
                <Ionicons
                  ...
                  size={37}
                  onPress={() => {
                    axios.patch(`https://dive-ios.appspot.com/bands/${userInfo.id}/insta`, {
